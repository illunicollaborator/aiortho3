...
export const DEFAULT_COLUMNS: TableColumn[] = [
  ...
  { id: 'lastPrescriptionDate', label: '최종 처방일', flex: 'flex-[1.0]', key: 'lastPrescriptionDate' },
  { id: 'status', label: '처방 상태', flex: 'flex-[0.8]', key: 'status' },
];

const STORAGE_KEY = 'nurse-home-patient-table-column-order';

// localStorage에서 컬럼 순서 불러오기
export const loadNurseHomePatientTableColumnOrder = (): TableColumn[] => {
...
export const saveNurseHomePatientTableColumnOrder = (columns: TableColumn[]): void => {
