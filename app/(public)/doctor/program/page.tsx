...
export default function ProgramPage() {
  ...
  return (
    <div className="bg-white flex px-20 pt-[52px] pb-[168px] flex-col overflow-hidden items-start justify-center md:px-5">
      <div className="flex w-[50vw] max-w-full flex-col items-stretch">
