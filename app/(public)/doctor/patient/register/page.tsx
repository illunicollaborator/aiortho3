...
const PatientRegisterPage = () => {
  ...
  return (
    <div className="bg-white flex w-full w-full pt-[1px] pb-[74px] flex-col items-start">
      <div className="flex mt-[52px] ml-8 md:ml-8 w-full max-w-[40vw] flex-col">
        ...
        <form onSubmit={handleSubmit} className="mt-[57px] w-full">
