  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      ...
      >
        ...
        <div className="modal-container w-full max-h-[636px] rounded-[24px] bg-white relative 
          ...
          <div className="table-section flex-1 flex flex-col px-6 sm:px-8 min-h-0">
            ...
            <div className="institutions-list flex-1 flex flex-col items-start overflow-y-auto min-h-0 
