      ...
      <div className="w-full flex px-4 sm:px-6 lg:px-8 flex-col items-stretch md:mt-8">
        ...
        <div className="hidden md:flex w-full items-stretch gap-5 font-pretendard flex-wrap justify-between">
          ...
          {isRoot && (
            <Button
              ...
              className="self-stretch rounded-[14px] min-h-[48px] px-5 py-3 text-sm text-white font-bold cursor-pointer"
            >
              가입 코드 발급
            </Button>
          )}
        ...
        <div className="flex md:hidden w-full flex-col gap-4 font-pretendard">
          ...
          {isRoot && (
            <Button
              onClick={handleIssueCode}
              className="w-full rounded-[14px] min-h-[48px] px-5 py-3 text-sm text-white font-bold  cursor-pointer"
            >
              가입 코드 발급
            </Button>
          )}
