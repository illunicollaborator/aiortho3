    ...
    <Dialog open={isOpen} onOpenChange={open => !open && onClose()}>
      ...
      >
        ...
        >
          ...
          {/* Table Section */}
          <div className="table-section flex-1 flex flex-col px-6 sm:px-8 pb-8 min-h-0">
            {/* Table Header */}
          ...
          {/* Pagination Section */}
          {totalPages > 1 && (
            <div className="pagination-section flex-shrink-0 flex justify-start py-4 sm:py-6 px-6 sm:px-8 border-t border-gray-100 bg-white">
              <Pagination
